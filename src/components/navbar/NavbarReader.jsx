    ...
    <>
      <div className="big-gap navbar-button-container">
        ...
        <div className="dark group navbar-button-container">
          <button className="nav-button svg-button" onClick={onPrevious} disabled={disablePrevious}>
            <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none">
              <path
          ...
          <button className="nav-button svg-button" onClick={onNext} disabled={disableNext}>
        ...
        {/* Search + Settings */}
        <div className="group navbar-button-container">
          <button className="nav-button svg-button" onClick={() => setShowComingSoon(true)}>
            <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none">
              <path
